...
public class AggregateTaskBuilder {
    ...
    public AggregateLog getLogForId( int id ) {
        return ( AggregateLog ) idToLogTable.get( new Integer( id ) ) ;
    }
    ...
    protected AggregateMPTaskLog makeNewAggregateMPTaskLog( MPTaskLog tl ) {
        ...
        idToLogTable.put( new Integer( avtl.getID() ) , avtl ) ;
        return avtl ;
    }
...
//                System.out.print( "," ) ;
    ...
    protected HashMap idToLogTable = new HashMap() ;
