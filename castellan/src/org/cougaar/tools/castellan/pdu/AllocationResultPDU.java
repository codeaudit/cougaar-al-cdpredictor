 ...
 * @version
 */
public class AllocationResultPDU extends UniqueObjectPDU {
    ...
    public AllocationResultPDU( UIDPDU planElementUID, short arType, int action, long executionTime, long time ) {
        super( planElementUID, EventPDU.TYPE_ALLOCATION_RESULT, action, executionTime, time ) ;
        this.arType = arType ;
    }
    ...
    public UIDPDU getPlanElementUID() { return getUID() ; }
