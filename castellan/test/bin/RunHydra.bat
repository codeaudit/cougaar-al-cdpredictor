set CASTELLANHOME=S:\psu_stuff\hydra
set LIBPATH=%CASTELLANHOME%/bin;%COUGAAR_INSTALL_PATH%/lib/core.jar;%COUGAAR_INSTALL_PATH%/lib/glm.jar;%COUGAAR_INSTALL_PATH%/sys/grappa1_2_bbn.jar;%CLASSPATH%
