...
public class ShortMatrixEnumeration {

    ShortMatrixEnumeration( ShortMatrix matrix ) {
        this.matrix = matrix ;
    ...
    ShortMatrixEnumeration( ShortMatrix matrix,  int[] lower, int[] upper ) {
        this.matrix = matrix ;
    ...
    public short nextElement() {
        short res = matrix.getArray()[lindex];
