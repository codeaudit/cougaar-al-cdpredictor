...
/**
 *   Implements a mplan using a simple representation for the databases.
 */
...
public class SimpleSearch extends AbstractSearch {
     ...
     *  because it has to linearly mplan through the graph.  However, this method
     *  is only called if a new, lower cost path has been found to an already expanded
     *  node.
     *
     *  @return true if the node n is found and removed, false otherwise.
     */
