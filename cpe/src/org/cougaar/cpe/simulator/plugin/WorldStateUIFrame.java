...
import org.cougaar.cpe.unittests.VGFrame;
...
public class WorldStateUIFrame extends JFrame {
    private WorldStateExecutorPlugin plugin;
    ...
    public WorldStateUIFrame( String agentName, WorldStateExecutorPlugin plugin ) throws HeadlessException {
    ...
    private void doConfigureAction() {
        plugin.processConfigureMessage();
