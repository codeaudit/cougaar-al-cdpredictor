...
public class ControlSourceBufferRelay implements Relay.Source, Serializable {
	private MessageAddress target;

	public ControlSourceBufferRelay(UID uid, MessageAddress target, MessageAddress source) {
	...
	private static final class SimpleRelayFactory implements TargetFactory, Serializable {
		...
		public Relay.Target create(
				...
				Object content,
				Token token) {
			return new ControlTargetBufferRelay(uid, source, content);
		}
