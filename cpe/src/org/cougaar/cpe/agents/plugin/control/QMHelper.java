...
//		}
	...
	public void invokeMatlab(double[][] stats) {
		...
		try {
			...
			//making the mean processing times into mean processing rates
			for (int i = 0; i < stats.length; i++) {
				if (stats[i][0]!=0) stats[i][0] = 1/stats[i][0];
			}

			//making the variance = mean^2, exponential assumption
			for (int i = 0; i < stats.length; i++) {
				stats[i][1] = Math.pow(stats[i][0], 2);
			}
			...
			//Svariances = "SV=[1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 1/100 ]";
			//Smeans="SM=[1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10 1/10]";
			
			System.out.println(Ameans + ";" + Avariances + ";" + Smeans + ";" + Svariances);
			eng.evalString(Ameans);
			eng.evalString(Avariances);
			eng.evalString(Smeans);
			eng.evalString(Svariances);
			eng.evalString("MPF=init(AM,AV,SM,SV)");
			
			//FloatMatrix fm1 = eng.getArray("SV");
			//System.out.println("MATLAB OUTPUT: " + fm1.toString());

			FloatMatrix fm = eng.getArray("MPF");
