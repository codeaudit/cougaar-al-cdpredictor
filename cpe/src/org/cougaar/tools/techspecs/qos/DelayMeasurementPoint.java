 ...
 * Time: 10:59:27 AM
 */
public class DelayMeasurementPoint extends MeasurementPoint {

    public DelayMeasurementPoint(String name) {
        super(name);
    }
    ...
    public long[][] getInterpolatedAndPreciseDelays( long startTime, long endTime, long sampleRate ) {
        ...
        while ( time <= endTime ) {
            DelayMeasurement last = (DelayMeasurement) getLastMeasurement() ;
            result[0][tindex] = time ;
            result[1][tindex] = time - last.getTimestamp() ;
            tindex ++ ;
            time += sampleRate ;
        }
    ...
    public static final void main( String[] args ) {
        DelayMeasurementPoint mp = new DelayMeasurementPoint( "Moose" ) ;
        ...
        delays = mp.getInterpolatedDelays( 3000, 15000, 500 ) ;
        System.out.println("Interpolated Delays (starting at 5000)=" );
        System.out.println( ArrayMath.toString( delays ) ) ;

        long[][] results = mp.getInterpolatedAndPreciseDelays( mp.getFirstLocalTime(), 15000, 500 ) ;
