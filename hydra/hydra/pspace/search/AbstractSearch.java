 ...
 *  database to see whether or not they already exist.  Optionally, the search may
 ...
 */ 
 public abstract class AbstractSearch implements GraphSearch {
     ...
     *  
     *  @param A strategy for expanding nodes.
     *  @param A graph node initializing the search.
     */
    ...
    /**
     *  Implements a standard graph search algorithm.
     */
    public void run() {
        int count = 1 ;
        // Choose the first
     ...
     *  before any goal node is found, the search has not been able to locate any
     *  paths to the goal.
     *
     ...
     *  In these cases, the search algorithm may remove n from the open list
